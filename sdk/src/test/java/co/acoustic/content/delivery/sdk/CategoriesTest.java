...
public class CategoriesTest {
    ...
    public void testCreationWithoutState() {
        ...
        Categories documents = new Categories(deliverySearch, null);
    ...
    public void testCreationWithState() {
        ...
        Categories documents = new Categories(deliverySearch, mockState);
    ...
    public void testCreationWithInjectedQueryBuilder() {
        ...
        Categories documents = new Categories(deliverySearch, null, queryBuilder);
    ...
    public void testCreationWithInjectedQueryBuilderAndState() {
        ...
        Categories documents = new Categories(deliverySearch, mockState, queryBuilder);
        verify(mockState).isIncludeDraft();
        verify(mockState).isIncludeProtectedContent();
        verify(mockState).isRetrieveCompleteContentContext();
        verify(mockState).isIncludeAllFields();
    ...
    public void testGetTargetDocumentClassification() {
        ...
        Categories documents = new Categories(deliverySearch, null, queryBuilder);
        assertEquals("category", documents.getTargetDocumentClassification());
    }
    ...
    public void testFilterBy() {
        ...
        Categories documents = new Categories(mock(DeliverySearch.class), null, queryBuilder);
    ...
    public void testGet() {
        ...
        final DeliverySearch deliverySearch = ContentDeliverySDK
                ...
                .deliverySearch();
        final DeliverySearchQueryBuilder queryBuilder = new DeliverySearchQueryBuilder();
        new Categories(deliverySearch, null, queryBuilder, new NetworkingCallsExecutorImpl())
                .get();
    }
    ...
    public void testThen() {
        final MockResponse successfulAssetsResponse = new MockResponse()
                ...
                .setBody(ResourceReader.read("categories_default_success_response.json"));
        ...
        final DeliverySearchQueryBuilder queryBuilder = new DeliverySearchQueryBuilder();
        final Categories documents = new Categories(deliverySearch, null, queryBuilder, new BlockingNetworkingCallsExecutor());
